...
<div class="adjusty-extended-nav">
  <div class="container">
    <div class="row">
      <div class="col s6"><a href="<?php echo $this->Url->build(['controller'=>'Plans', 'action'=>'list']); ?>">リスト表示</a></div>
      <div class="col s6"><a href="<?php echo $this->Url->build(['controller'=>'Plans', 'action'=>'calendar']); ?>" class="indicator">カレンダー表示</a></div>
    </div>
  </div>
</div>
