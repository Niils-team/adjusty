  ...
  <div class="planlists">
    ...
    <div class="row planlists-item">
      ...
      <div class="modal-content">
        <h4 class="modal-font"><?php echo date('Y年m月d日', strtotime($event['start'])); ?>　<?php echo $event['memo']; ?>　
          <?php
        # 終日チェック
        if ($event['allDay'] == 1) {
          echo '終日';
        ...
        ?></h4>
        <p>こちらの日時で確定します。よろしいですか？確定する場合はお名前を入力後、「確定ボタン」をクリックしてください。</p>
