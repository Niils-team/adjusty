...
<div class="calenders index large-9 medium-8 columns content">
    <h3><?= __('Calenders') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $calender->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $calender->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $calender->id], ['confirm' => __('Are you sure you want to delete # {0}?', $calender->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
