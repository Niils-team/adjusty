...
class UsersController extends AppController
{
    ...
    public function test()
    {
        ...
        // $client->setRedirectUri( 'https://adjusty.me/plans/calendar' );
        ...
        // $new_event->start->dateTime = '2017-05-14T09:00:00+09:00';
        // $new_event->end = new \Google_Service_Calendar_EventDateTime();
        // $new_event->end->dateTime = '2017-05-15T18:00:00+09:00';
        //
        // // (3) カレンダーにイベントを登録する
